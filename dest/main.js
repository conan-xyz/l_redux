...
/***/ function(module, exports, __webpack_require__) {
	...
	// 发起一系列 action
	store.dispatch((0, _index3.addTodo)('Learn about actions'));
	store.dispatch((0, _index3.addTodo)('Learn about reducers'));
	store.dispatch((0, _index3.addTodo)('Learn about store'));
	store.dispatch((0, _index3.toggleTodo)(0));
	store.dispatch((0, _index3.toggleTodo)(1));
	store.dispatch((0, _index3.setVisibilityFilter)(_index3.VisibilityFilters.SHOW_COMPLETED));
...
/***/ function(module, exports, __webpack_require__) {
	...
	function visibilityFilter() {
	    var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : _index.VisibilityFilters.SHOW_ALL;
	    var action = arguments[1];
